  ...
  render() {
    return(
      <form className="note-input" onSubmit={this.onInsertClicked}>
        ...
        <input type="text" value={this.state.noteTitle} placeholder='Ini adalah judul' onChange={this.onNoteTitleChangeHandler}/>
        <textarea placeholder="Tuliskan catatanmu disini" value={this.state.noteBody} onChange={this.onNoteBodyChangeHandler} rows="10"></textarea>
